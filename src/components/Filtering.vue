<template>
  <div class="">
    ...
    <div class="my-6 block md:flex gap-4 justify-center md:mx-0 mx-4">
      ...
      <BaseSelect v-model="filters.provider_id" @update:modelValue="applyFilters" :options="providers" :isAssociativeArray="true" addFirstOption="All providers" wrapperClass="mt-2 md:!w-1/4  !w-full" />
    </div>
  </div>
</template>
